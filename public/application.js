...
var winCombos = [[board[0], board[1], board[2]], [board[3], board[4], board[5]], [board[6], board[7], board[8]], [board[0], board[3], board[6]], [board[1], board[4], board[7]], [board[2], board[5], board[8]], [board[0], board[4], board[8]], [board[2], board[4], board[5]]];

// Change Turns and print X or O based on respctive turn
var turn = '';
var changeTurn = function changeTurn(data) {
...
// Play again functon
var playAgain = function playAgain(event) {
  event.preventDefault();
  // Show game board
  $('#game-board').show();
  ...
  // Create Post Request
  api.gameStart().then(ui.gameStartSuccess);
};

var onGetGameIndex = function onGetGameIndex() {
  api.gameIndex().then(ui.gameIndexSuccess);
};
...
var onUpdateGame = function onUpdateGame(event) {
  ...
  var turn = event.target.innerText;
  var isOver = winCondition();
  api.gameUpdate(data, turn, isOver).then(ui.gamePatchSuccess);
};
var gameState = function gameState() {
  ...
  api.gameUpdate().then(ui.gamePatchSuccess);
};
...
var gameUpdate = function gameUpdate(data, turn, isOver) {
  return $.ajax({
...
var gamePatchSuccess = function gamePatchSuccess(data) {
  store.game = data.game;
};
...
module.exports = {
  ...
  gamePatchSuccess: gamePatchSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
